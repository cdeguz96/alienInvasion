...
class Ship(Sprite):
    images = [pg.image.load('images/Fighter_Jet_Scalex3.bmp')]
    # images_for_boom = [pg.image.load('images/ship_boom' + str(i) + '.png') for i in range(4)]
    images_for_boom = [pg.image.load('images/Jet_Explode/Explode_0' + str(i) + '.png') for i in range(10)]
    append = [pg.image.load('images/Jet_Explode/Explode_' + str(i) + '.png') for i in range(10, 13)]
    images_for_boom.extend(append)
    ...
    def __init__(self, sound, game, barriers=None, aliens=None):
        ...
        self.image = pg.image.load('images/Fighter_Jet_Scalex3.bmp')
